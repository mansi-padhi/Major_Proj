...
class CostComponent extends React.Component {
    ...
    onClickbutton1() {
        ...
        if (window.selectedperiod === "today") {
            ...
            document.getElementById("co-tablecell-value1").innerHTML = "Rs " + monthArr[1];
            ...
            document.getElementById("co-tablecell-value2").innerHTML = "Rs " + sfmVal;

            document.getElementById("co-tablecell-title3").innerHTML = "Predicted This Month";
            document.getElementById("co-tablecell-value3").innerHTML = "Rs " + monthArr[2];

            document.getElementById("co-tablecell-title4").style.display = "block";
            document.getElementById("co-tablecell-value4").style.display = "block";

            document.getElementById("co-tablecell-title4").innerHTML = "Estimated savings";
            document.getElementById("co-tablecell-value4").innerHTML = "Rs " + Math.round((monthArr[2] - monthArr[1]) * 100) / 100;
            ...
            document.getElementById("co-tablecell-value1").innerHTML = "Rs " + yearArr[1];
            ...
            document.getElementById("co-tablecell-value2").innerHTML = "Rs " + styVal;


            document.getElementById("co-tablecell-title3").innerHTML = "Predicted This Year";
            document.getElementById("co-tablecell-value3").innerHTML = "Rs " + yearArr[2];

            document.getElementById("co-tablecell-title4").style.display = "block";
            document.getElementById("co-tablecell-value4").style.display = "block";

            document.getElementById("co-tablecell-title4").innerHTML = "Estimated Savings";
            document.getElementById("co-tablecell-value4").innerHTML = "Rs " + Math.round((yearArr[1] - yearArr[2]) * 100) / 100;
        }
    ...
    onClickbutton2() {
        ...
        if (window.selectedperiod === "today") {
            ...
            document.getElementById("co-tablecell-value1").innerHTML = "Rs " + yearArr[0];

            document.getElementById("co-tablecell-title2").innerHTML = moment().subtract(1, 'year').format('YYYY');
            document.getElementById("co-tablecell-value2").innerHTML = "Rs " + yearArr[1];

            document.getElementById("co-tablecell-title3").innerHTML = "Savings";
            document.getElementById("co-tablecell-value3").innerHTML = "Rs " + Math.round((yearArr[0] - yearArr[1]) * 100) / 100;
